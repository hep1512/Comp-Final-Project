...
object RecommendationRepository {
    fun recommendationsForCustomer(
        username: String,
        limit: Int = 4,
        ...
        return products.map { product ->
            ...
            val personalScore =
                if (history.categoryQuantities.isEmpty()) {
                    categoryScore * 0.5
                } else {
    ...
    private fun customerHistory(username: String): CustomerHistory =
        transaction {
            val userId =
                Users.selectAll()
                    .map { it }
    ...
    private fun priceFitScore(
        productPrice: Double,
        targetItemPrice: Double,
    ): Double {
